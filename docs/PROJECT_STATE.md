...
## Current milestone
**BUG GATE (second engagement, 2026-07-11)** — BUG-005…009 in [BACKLOG.md](BACKLOG.md). P4 shipped (RH-401…404; suite 788/310 green) but human testing found new defects, incl. one REOPEN (fact extraction — post-mortem of prior fix's tests required, see BUG-006). P3 and P4 acceptance both CONDITIONAL until gate clears.
Dispatch: BUG-005/006/007/008 in parallel → BUG-009 smoke hardening (requires post-mortems from the others).
...
| Bug gate 2 | BUG-005…009 | **OPEN — blocks all feature work** |
